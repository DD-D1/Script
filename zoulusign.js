...
function Card(timeout = 0)
{
    return new Promise((resolve) =>
    {
        setTimeout(() =>
        {
            Cardbody = `device=ios&id=1&imei=b857b4bfdbddaa304ddd0b6ba1b538f64606d69c&source=ios&uid=3931487&version=1.2.18`;
            let Url = {
...
function randCoin(timeout = 0)
{
    return new Promise((resolve) =>
    {
        setTimeout(() =>
        {
            Coin = Math.floor(Math.random() * 20);
            coinbody = `coin=${Coin}&device=ios&double=0&imei=b857b4bfdbddaa304ddd0b6ba1b538f64606d69c&source=ios&uid=3931487&version=1.2.18`;
            let Url = {
...
function member(timeout = 0)
{
    return new Promise((resolve) =>
    {
        setTimeout(() =>
        {
            memberbody = `device=ios&imei=b857b4bfdbddaa304ddd0b6ba1b538f64606d69c&source=ios&step=${nique}&uid=3931487&version=1.2.18`;
            let Url = {
...
function drink(timeout = 0)
{
    return new Promise((resolve) =>
    {
        ...
        {
            coin = 5;
            drinkbody = `coin=${coin}&cupid=${cupid}&device=ios&double=1&imei=b857b4bfdbddaa304ddd0b6ba1b538f64606d69c&source=ios&uid=3931487&version=1.2.18`;
            let Url = {
